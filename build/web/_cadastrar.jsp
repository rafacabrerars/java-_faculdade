...
<html lang="en">
    <head>
        ...
        <title>Tela de Login - Bootsnipp.com</title>
        ...
        <div class="container">
            <div class="card card-container">
                ...
                <form class="form-signin" action="ServletLogin" method="POST" >
                    ...
                    <input type="text" id="nome" name="login" class="form-control" placeholder="Nome" required autofocus>
                    <input type="password" id="senha" name="senha" class="form-control" placeholder="Senha" required>
                    <input type="password" id="senha2" name="senha2" class="form-control" placeholder="Confirmar Senha" required autofocus>
